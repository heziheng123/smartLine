  ...
  return (
    <main className="review-view" aria-label="每日复盘">
      ...
      <section className="review-card">
        ...
        <footer className="review-card__footer"><span>{current.inputSegments.length} 段原始记录 · 仅本机保存</span><button type="button" className="review-button review-button--primary" onClick={finish} disabled={current.reviewStatus === 'completed'}><Check size={16} />完成复盘</button></footer>
      </section>
