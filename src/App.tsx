...
import { PERSISTENCE_ERROR_EVENT } from '@/utils/persistence';
...
const App: React.FC = () => {
  ...
  React.useEffect(() => {
    ...
    window.addEventListener(PERSISTENCE_ERROR_EVENT, handleQueueError);
    return () => {
      ...
      window.removeEventListener(PERSISTENCE_ERROR_EVENT, handleQueueError);
    };
  }, []);
